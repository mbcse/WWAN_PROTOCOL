...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/CP1UDaRrkX)
...
```sh
npx nx serve codebase
```

To create a production bundle:

```sh
npx nx build codebase
```

To see all available targets to run for a project, run:

```sh
npx nx show project codebase
```
